...
<!--      </el-col>-->
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['adopt:circle:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['adopt:circle:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listCircle, getCircle, delCircle, addCircle, updateCircle } from "@/api/adopt/circle";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('adopt/circle/export', {
        ...this.queryParams
