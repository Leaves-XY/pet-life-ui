<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="cyclopediaList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
<!--      <el-table-column label="id" align="center" prop="id" />-->
      <el-table-column label="标题" align="center" prop="title" show-overflow-tooltip />
      <el-table-column label="图片" align="center" prop="picture" show-overflow-tooltip />
      <el-table-column label="内容(富文本)" align="center" prop="content" show-overflow-tooltip />
      <el-table-column label="类型" align="center" prop="type" width="80">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.cyclopedia_type" :value="scope.row.type"/>
        </template>
      </el-table-column>
...
:value="dict.value"
        ...
        <el-form-item label="标签背景颜色" prop="backgroundColor">
          <el-input v-model="form.backgroundColor" placeholder="请输入标签背景颜色" />
        </el-form-item>
        <el-form-item label="是否删除" prop="isDeleted">
...
<script>
import { listCyclopedia, getCyclopedia, delCyclopedia, addCyclopedia, updateCyclopedia } from "@/api/adopt/cyclopedia";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除宠物科普编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('adopt/cyclopedia/export', {
        ...this.queryParams
