...
<!--      <el-table-column label="ID" align="center" prop="id" />-->
      <el-table-column label="用户ID" align="center" prop="openId" width="" show-overflow-tooltip />
...
<!--        <template slot-scope="scope">-->
<!--          <dict-tag :options="dict.type.pet_sex" :value="scope.row.gender"/>-->
<!--        </template>-->
<!--      </el-table-column>-->
      <el-table-column label="手机号" align="center" prop="phone" width="160" />
<!--      <el-table-column label="邮箱" align="center" prop="email" />-->
      <el-table-column label="用户类型" align="center" prop="userType" width="160" />
<!--      <el-table-column label="状态 (0-正常 1-禁用 2-黑名单)" align="center" prop="status" />-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="session_key" prop="sessionKey">
          <el-input v-model="form.sessionKey" placeholder="请输入session_key" />
        </el-form-item>
...
<script>
import { listUser, getUser, delUser, addUser, updateUser } from "@/api/adopt/user";

export default {
  name: "User",
  dicts: ['pet_sex', 'is_deleted'],
  data() {
    return {
      // 遮罩层
      loading: true,
      ...
      rules: {
        ...
        sessionKey: [
          { required: true, message: "session_key不能为空", trigger: "blur" }
        ],
        unionId: [
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('adopt/user/export', {
        ...this.queryParams
